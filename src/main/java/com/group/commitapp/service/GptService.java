...
public class GptService {
	...
	public String requestGPT(String prompt) {
		...
		//        prompt = "다음 커밋 정보json을 보고 코드리뷰를 작성해줘 , 반드시 {summary:, code_review:}과 같은 json형식으로 한국어로
		// 작성해줘, 무조건 json으로만 해야해." +
		//                " summary는 한줄의 명사형으로 끝나야해. code_review는 300자 내외로 코드리뷰와 칭찬할점,개선점을 반드시 포함해서
		// 종결형으로 작성해줘"
		//                + prompt;
		prompt =
				"다음 커밋 정보 JSON을 보고 코드리뷰를 작성해주세요."
		...
		GPTRequest request = new GPTRequest(model, prompt, 0.2, 256, 0.8, 0.2, 0.1);
